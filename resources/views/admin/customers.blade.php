                        ...
                        <div class="form-group form-group--inline col-12 col-sm-auto d-none d-sm-block">
                            <div class="toolbox__status input-group input-group--white input-group--append">
                                ...
                                <div class="dropdown-menu dropdown-menu--right dropdown-menu--fluid js-dropdown-select">
                                    ...
                                    <a class="dropdown-menu__item" href="#" tabindex="0" data-value="Active"><span
                                            class="marker-item color-green"></span> Active</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <table class="table table--spaces">
                    ...
                    <thead class="table__header">
                        <tr class="table__header-row">
                            ...
                            <th class="table__th-sort"><span class="align-middle">Orders</span><span
                                    class="sort sort--down"></span>
                            </th>
                            <th class="table__th-sort"><span class="align-middle">Registered</span><span
                                    class="sort sort--down"></span>
                            </th>
                    ...
                    <tbody>
                        <tr class="table__row">
                            ...
                            <td class="table__td">
                                <div class="media-item media-item--medium">
                                    ...
                                    <div class="media-item__right">
                                        <h5 class="media-item__title"><a href="customer-account.html">Felecia Burke</a>
                                        </h5><a class="text-sm text-grey" href="mailto:#">example@mail.com</a>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="table__td d-none d-sm-table-cell">
                                <div class="table__status"><span class="table__status-icon color-green"></span> Active
                                </div>
                            </td>
                        ...
                        <tr class="table__row">
                            ...
                            <td class="table__td">
                                <div class="media-item media-item--medium">
                                    ...
                                    <div class="media-item__right">
                                        <h5 class="media-item__title"><a href="customer-account.html">Sophia Hale</a>
                                        </h5><a class="text-sm text-grey" href="mailto:#">example@mail.com</a>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr class="table__row">
                            ...
                            <td class="table__td">
                                <div class="media-item media-item--medium">
                                    ...
                                    <div class="media-item__right">
                                        <h5 class="media-item__title"><a href="customer-account.html">Pamela Garza</a>
                                        </h5><a class="text-sm text-grey" href="mailto:#">example@mail.com</a>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr class="table__row">
                            ...
                            <td class="table__td">
                                <div class="media-item media-item--medium">
                                    ...
                                    <div class="media-item__right">
                                        <h5 class="media-item__title"><a href="customer-account.html">Addison James</a>
                                        </h5><a class="text-sm text-grey" href="mailto:#">example@mail.com</a>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr class="table__row">
                            ...
                            <td class="table__td">
                                <div class="media-item media-item--medium">
                                    ...
                                    <div class="media-item__right">
                                        <h5 class="media-item__title"><a href="customer-account.html">Jamie Rhodes</a>
                                        </h5><a class="text-sm text-grey" href="mailto:#">example@mail.com</a>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr class="table__row">
                            ...
                            <td class="table__td">
                                <div class="media-item media-item--medium">
                                    ...
                                    <div class="media-item__right">
                                        <h5 class="media-item__title"><a href="customer-account.html">Addison Jones</a>
                                        </h5><a class="text-sm text-grey" href="mailto:#">example@mail.com</a>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr class="table__row">
                            ...
                            <td class="table__td">
                                <div class="media-item media-item--medium">
                                    ...
                                    <div class="media-item__right">
                                        <h5 class="media-item__title"><a href="customer-account.html">Lynn George</a>
                                        </h5><a class="text-sm text-grey" href="mailto:#">example@mail.com</a>
                                    </div>
                                </div>
                            </td>
                                ...
                                <div class="media-item media-item--medium">
                                    ...
                                    <div class="media-item__right">
                                        <h5 class="media-item__title"><a href="customer-account.html">Christine
                                                Lewis</a></h5><a class="text-sm text-grey"
